...
(function() {
  $(function() {
    if ($('#ep-show-suggested-friends').length) {
      ...
      $('#ep-invited').hide();
      $('#ep-invited_by').hide();
      $('#ep-show-friends').click(function() {
      ...
      $('#ep-show-invites').click(function() {
        $('.ep-active-connections').removeClass('ep-active-connections');
        $(this).addClass('ep-active-connections');
        $('#ep-invited').show();
        $('#ep-invited_by').hide();
      ...
      $('#ep-show-inviters').click(function() {
        $('.ep-active-connections').removeClass('ep-active-connections');
        $(this).addClass('ep-active-connections');
        $('#ep-invited_by').show();
        $('#ep-invited').hide();
      ...
      $('#ep-show-suggested-friends').click(function() {
        $('.ep-active-connections').removeClass('ep-active-connections');
        $(this).addClass('ep-active-connections');
